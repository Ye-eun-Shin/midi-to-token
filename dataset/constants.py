...
DAC_PRETRAINED_MODEL_PATH = os.path.join(
    root_dir, "stream_music_gen/250121_stemmix_dac_weights_400k_steps.pth"
) # /workspace/stream-music-gen/stream_music_gen/250121_stemmix_dac_weights_400k_steps.pth
